M.mod_forumng = {
    ...
    init_content : function(node) {
        ...
        node.all('a').each(function(link, index, list) {
            ...
            if (match) {
                this.init_reply(link, parseInt(match[1]) + "&mode=freewriting");
            }
    ...
    init_iframe : function(src, post) {
        ...
        iframe.set('className', 'forumng-inlineform aaaaaaa');
        iframe.set('height', 500);
        src += '&iframe=1&iiiiiiiiiii=2';
        iframe.set('src', src);
    ...
    init_reply: function(link, replytoid) {
        ...
        link.on('click', function(e) {
            ...
            if (draft) {
                ...
                src += 'replyto=' + replytoid + "&mode=freewriting";
            }
            if (this.cloneid) {
                src += '&clone=' + this.cloneid;
            }
