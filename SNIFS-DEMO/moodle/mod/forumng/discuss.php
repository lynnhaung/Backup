...
echo '<script src="/freewriting/jquery.js" type="text/javascript"></script>';
if (isset($_GET["mode"]) && $_GET["mode"] === "discuss") {
	echo '<script src="/freewriting/discuss.js" type="text/javascript"></script>';
	echo '<link rel=stylesheet type="text/css" href="/freewriting/discuss.css">';
}
else if (isset($_GET["mode"]) && $_GET["mode"] === "freewriting") {
	echo '<script src="/freewriting/freewriting.js" type="text/javascript"></script>';
	echo '<link rel=stylesheet type="text/css" href="/freewriting/freewriting.css">';
}
