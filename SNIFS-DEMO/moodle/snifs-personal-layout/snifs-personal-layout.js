...
function create_Wordtable(data) {
    ...
    var table_body = '<thead><tr><th colspan = "4">搜尋[' +
        '<a class="search_word" words = "'+data[0][0]+'" href="/mod/hsuforum/search.php?id=73&words=' + encodeURI(data[0][0]) + '" target="search_discuss" >' +
        data[0][0] +
        '</a>' +
...
//    ga("send", _stmt);
    ...
    $('#keyword_table').find("a").click(function () {
        ...
        //var _words = jQuery(this).attr("words");
//        var _dataset = get_user_id() + ": " + get_timestamp() + ": " + _dataWord + ": " + _user + ": " + _count;
        var _stmt = {
            hitType: 'event',
...
function create_Team_Wordtable(data, _words) {
    ...
    var table_body = '<thead><tr><th colspan = "4">搜尋[' +
        '<a class="search_word" words="' + _words + '" href="/mod/hsuforum/search.php?id=73&words=' + encodeURI(data[0][0]) + '" target="search_discuss" >' +
        data[0][0] +
        '</a>' +
...
//    ga("send", _stmt);
    ...
    $('#keyword_table').find("a").click(function () {
        ...
        var _teamcount = jQuery(this).attr("teamcount");
        //console.log(_word);
//        var _dataset = get_user_id() + ": " + get_timestamp() + ": " + _words + ": " + _user + ": " + _teamcount;
        var _stmt = {
            hitType: 'event',
